...
require_once XOOPS_ROOT_PATH.'/modules/pages/fpdf/fpdf.inc.php';
...
if (!$gperm_handler->checkRight("Page_permissions", $article->topicid(), $groups, $xoopsModule->getVar('mid'))) {
